...
CREATE OR REPLACE STORAGE INTEGRATION INT_AWS_S3
  ...
  STORAGE_PROVIDER = S3
  ENABLED = TRUE 
   STORAGE_AWS_ROLE_ARN = 'arn:aws:iam::759910672758:role/aws_s3_snowflake_intg'
  STORAGE_ALLOWED_LOCATIONS = ('s3://snowflakebucket2407/output/')
...
CREATE OR REPLACE stage mydb.public.stage_aws_pipes
     URL = 's3://snowflakebucket2407/output/'
